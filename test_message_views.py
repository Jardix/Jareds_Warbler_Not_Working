...
class MessageViewTestCase(TestCase):
    ...
    def setUp(self):
        ...
        # Why would this line change from solution to base code? I have no idea; but it did. Above is original, below is the solution text.
        db.drop_all()
        db.create_all()
    ...
    def test_message_show(self):
        ...
        m = Message(
            id=1234,
            text="test_message_views.py first test message",
    ...
    def test_message_delete(self):
        ...
        m = Message(
            id=1234,
            text="test_message_views.py second test message",
            user_id=self.testuser_id
        )
        db.session.add(m)
        db.session.commit()
    ...
    def test_message_delete_no_authentication(self):
        ...
        m = Message(
            id=1234,
            text="test_message_views.py fourth test message",
            user_id=self.testuser_id
        )
        db.session.add(m)
        db.session.commit()
